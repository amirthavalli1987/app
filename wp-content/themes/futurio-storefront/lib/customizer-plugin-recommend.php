...
$config_customizer = array(
	'recommended_plugins' => array( 
		'futurio-extra' => array(
			...
			'description' => sprintf( esc_html__( 'To take full advantage of all the features this theme has to offer, please install and activate the %s plugin.', 'futurio-storefront' ), '<strong>Futurio Storefront Extra</strong>' ),
		),
	),
	/* translators: %s: Theme name */
        'recommended_plugins_title' => sprintf( esc_html__( 'Thank you for installing %s.', 'futurio-storefront' ), 'Futurio' ),
