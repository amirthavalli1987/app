<?php
/**
 * Futurio Storefront Plugin Install Class
 * 
 */
...
if ( ! class_exists( 'Futurio_Storefront_Plugin_Install' ) ) :
	/**
	 * The Futurio Storefront plugin install class
	 */
	class Futurio_Storefront_Plugin_Install {
		...
		public static function install_plugin_button( $plugin_slug, $plugin_file, $plugin_name, $classes = array(), $activated = '', $activate = '', $install = '' ) {
			if ( current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) {
				if ( is_plugin_active( $plugin_slug . '/' . $plugin_file ) ) {
					...
					$button = array(
						'message' => esc_attr__( 'Activated', 'futurio-storefront' ),
						'url'     => '#',
					...
					$button = array(
						'message' => esc_attr__( 'Activate', 'futurio-storefront' ),
						'url'     => $url,
					...
					$button = array(
						'message' => esc_attr__( 'Install now', 'futurio-storefront' ),
						'url'     => $url,
				...
				<a href="https://wordpress.org/plugins/<?php echo esc_attr( $plugin_slug ); ?>" target="_blank"><?php esc_html_e( 'Learn more', 'futurio-storefront' ); ?></a>
				<?php
			}
		}
...
return new Futurio_Storefront_Plugin_Install();
